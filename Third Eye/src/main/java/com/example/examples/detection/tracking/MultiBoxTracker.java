...
package com.example.examples.detection.tracking;
...
import com.example.examples.detection.tflite.Classifier.Recognition;
...
public class MultiBoxTracker {
  ...
  public synchronized void drawDebug(final Canvas canvas) {
    ...
    for (final Pair<Float, RectF> detection : screenRects) {
      ...
      logger.i("(%d,%d)", rect.centerX(), rect.centerY());
    }
  ...
  private void processResults(final List<Recognition> results) {
    ...
    for (final Pair<Float, Recognition> potential : rectsToTrack) {
      ...
      final RectF location = potential.second.getLocation();
