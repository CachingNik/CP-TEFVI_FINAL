...
public abstract class CameraActivity extends AppCompatActivity
        ...
        View.OnClickListener, GvrView.StereoRenderer {
    ...
    public volatile int sourceId = GvrAudioEngine.INVALID_ID;
    public volatile int successSourceId = GvrAudioEngine.INVALID_ID;
    //---------------------------------------------------------------
...
//            if(sourceId == GvrAudioEngine.INVALID_ID)System.out.println("THIK the id was invalid");
